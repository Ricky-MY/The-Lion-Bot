...
from bot.utilities._converters import FetchDiscordUser
...
class Ban(commands.Cog):
    ...
    async def kick(self, ctx: Context, member: FetchDiscordUser, *, reason="Unspecified"):
        """
    ...
    @commands.guild_only()
    async def ban(self, ctx: Context, member: FetchDiscordUser, *, reason="Unspecified"):
        """
    ...
    async def clear(self, ctx: Context, amount: int =5, user: FetchDiscordUser = None):
        """
