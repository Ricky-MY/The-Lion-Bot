...
from bot.constants import Colour, Props
from bot.extensions.utils.prefixes import Prefixes
...
class Help(commands.Cog):
    ...
    def __init__(self, bot):
        ...
        self.embed.set_author(
            name="Pill's help menu", icon_url=Props.CHARACTER_URL)
    ...
    async def help(self, ctx, module=None):
        ...
        embed.description = Props.HELP_DESCRIPTION
    ...
    async def get_cog_help(self, ctx, module):
        cogs = {"ban": (("Ban", "Mute", "Silent"), "⚒️ Moderation"),
                "miscellaneous": (("Misc", "TypeWriter", "Prefixes", "GetSource", "Prefixes"), "🧰 Miscellaneous"),
                "magic": (("MiniGames", "ConnectFour"), "🪄 Magic")}
